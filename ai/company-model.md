...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "YouGov") |
| group        | string   | Parent company group (e.g. "YouGov") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/peviitor-scrapers/yougov-cp-romania-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)