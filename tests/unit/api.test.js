...
describe('scraper/api.js', () => {
  ...
  describe('querySOLR', () => {
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.querySOLR('48869513')).rejects.toThrow('API jobs query error: 500');
    });
  });
  ...
  describe('deleteJobsByCIF', () => {
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.deleteJobsByCIF('48869513')).rejects.toThrow('API jobs delete error: 500');
    });
  });
